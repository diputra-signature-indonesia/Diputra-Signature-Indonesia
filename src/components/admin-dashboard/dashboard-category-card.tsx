import type { TaskInternalServiceSummary } from '@/data/admin-dashboard/dashboard-dummy-data';
      ...
      <div className="mt-6 flex flex-col items-center justify-center gap-8 sm:flex-row">
        ...
        <ul className="w-full max-w-48 space-y-3">
          {internalServices.map((service) => (
            <li key={service.label} className="grid grid-cols-[12px_1fr_auto] items-center gap-2 text-sm text-[#303846]">
