export function CompanyOverviewSection() {
  return (
    <section id="company-overview" className="brand-section-px brand-stretch brand-section-my mx-auto mt-30 max-w-[1440px] xl:h-[600px]">
      <div className="mx-auto max-w-[1000px]">
        ...
        <div className="relative">
          ...
          <p className="brand-p-desc text-brand-black hidden md:block md:text-justify">
