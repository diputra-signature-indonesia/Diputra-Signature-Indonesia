...
export function HeroSection() {
  return (
    <section id="hero-section" className="brand-stretch font-raleway brand-section-px mx-auto flex h-[95svh] max-w-[1440px] pb-20 max-md:flex-col sm:h-svh sm:max-h-[700px] sm:gap-10 lg:gap-20">
