...
export const initialAllJobsFilters: AllJobsFilterState = {
  ...
  internalService: allJobsFilterOptions.internalServices[0],
...
const jobTemplates: Omit<AllJob, 'id'>[] = [
  {
    title: 'Registrasi NPWP', client: 'PT. Sunji Bakti Inc', pic: 'Dalem', picInitials: 'DA', internalService: 'Tax Registration', stage: 'Revision', progress: 40,
  ...
  {
    title: 'Terminated Stay Permit (TSP)', client: 'PT. Sunji Bakti Inc', pic: 'Dalem', picInitials: 'DA', internalService: 'Stay Permit Termination', stage: 'Review', progress: 40,
  ...
  {
    title: 'KITAS Investor 2 Years', client: 'PT. Sunji Bakti Inc', pic: 'Putra', picInitials: 'PU', internalService: 'Investor KITAS', stage: 'Drafting', progress: 20,
  ...
  {
    title: 'PMA Establishment', client: 'Maria Gonzalez', pic: 'Rhea', picInitials: 'RH', internalService: 'PMA Establishment', stage: 'Analysis', progress: 10,
  ...
  {
    title: 'Property Due Diligence', client: 'PT Nusantara Property', pic: 'Dewa', picInitials: 'DE', internalService: 'Property Due Diligence', stage: 'Document Check', progress: 55,
  ...
  {
    title: 'Company Deed Amendment', client: 'PT Arta Jaya', pic: 'Ayu', picInitials: 'AY', internalService: 'Company Deed Amendment', stage: 'Client Review', progress: 70,
  ...
  {
    title: 'Trademark Registration', client: 'Bali Creative Studio', pic: 'Putra', picInitials: 'PU', internalService: 'Trademark Registration', stage: 'Submission', progress: 80,
  ...
  {
    title: 'Investor KITAS Extension', client: 'Sakura Trading', pic: 'Rhea', picInitials: 'RH', internalService: 'Investor KITAS Extension', stage: 'Apply', progress: 60,
  ...
  {
    title: 'Business License Update', client: 'Green Island Ventures', pic: 'Dewa', picInitials: 'DE', internalService: 'Business License Update', stage: 'Analysis', progress: 0,
  ...
  {
    title: 'Employment Agreement', client: 'PT Merah Putih Digital', pic: 'Ayu', picInitials: 'AY', internalService: 'Employment Agreement', stage: 'Completed', progress: 100,
  ...
  {
    title: 'Tourism Business License', client: 'Oceanic Resort Bali', pic: 'Dalem', picInitials: 'DA', internalService: 'Tourism Business License', stage: 'Document Check', progress: 35,
  ...
  {
    title: 'Land Lease Agreement', client: 'Ubud Living Group', pic: 'Putra', picInitials: 'PU', internalService: 'Land Lease Agreement', stage: 'Drafting', progress: 25,
